...
;   (let [slack-org-id (:slack-org-id share-request)
...
;     (try
;       (if-let* [new-update (story-res/->update conn org-slug share-request author)
...
;   (if-let* [update-result (story-res/create-update! conn (update new-update :to distinct)) ; Add the update
...
;   ;; Responses
;   :handle-ok (fn [ctx] (update-rep/render-story org-slug (:existing-update ctx))))
