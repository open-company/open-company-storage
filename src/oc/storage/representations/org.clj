...
(def representation-props (concat public-representation-props [:author :authors :must-see-count :default-section-names]))
...
(defn render-org
  ...
  (let [slug (:slug org)
    ...
    (json/generate-string
      (-> org
        (assoc :default-section-names (vec (sort config/sections)))
